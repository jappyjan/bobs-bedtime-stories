...
`,Oi=class extends _o{render(){return to` <slot></slot> `}};Oi.styles=_i;An(n,"sl-visually-hidden",Oi=ee([wn("sl-visually-hidden")],Oi),{});var Ti=No`
  ${Ko}
