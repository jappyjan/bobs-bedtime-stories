...
exports.getBooks = (0, wrap_api_handler_1.wrapApiHandler)(() => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    const scanAction = dynamoose_1.BookModel.scan();
...
exports.postBook = (0, wrap_api_handler_1.wrapApiHandler)((event) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    return yield dynamoose_1.BookModel.create({
        title: body.title,
...
exports.getStoriesOfBook = (0, wrap_api_handler_1.wrapApiHandler)((event) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    return yield dynamoose_1.StoryModel.query()
        .attribute('bookSlug')
        .eq(bookSlug)
        .all()
        .exec();
...
exports.postANewEpisode = (0, wrap_api_handler_1.wrapApiHandler)((event) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    const bookSlug = event.pathParameters.bookSlug;
    const storiesSortedByEpisode = yield dynamoose_1.StoryModel.query()
    ...
    const story = yield dynamoose_1.StoryModel.create({
        bookSlug,
        episode,
        date: new Date(),
        audioS3Key: s3Key
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BookModel = exports.BookSchema = exports.BookTableName = exports.BookDocument = void 0;
const dynamoose_1 = __webpack_require__("dynamoose");
...
exports.BookModel = (0, dynamoose_1.model)(exports.BookTableName, exports.BookSchema, {
    create: false,
    update: false,
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.StoryModel = exports.StorySchema = exports.StoryTableName = exports.StoryDocument = void 0;
const dynamoose_1 = __webpack_require__("dynamoose");
const Document_1 = __webpack_require__("dynamoose/dist/Document");
class StoryDocument extends Document_1.Document {
}
exports.StoryDocument = StoryDocument;
exports.StoryTableName = 'stories';
...
exports.StoryModel = (0, dynamoose_1.model)(exports.StoryTableName, exports.StorySchema, {
    create: false,
    update: false,
});
